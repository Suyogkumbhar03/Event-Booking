    ...
    return (
        <div className="max-w-md mx-auto my-12 bg-white p-8 border border-[#DCD7CE] shadow-sm space-y-6 font-sans text-[#141413]">
            <div className="text-center space-y-2 border-b border-[#DCD7CE] pb-6">
                ...
                <p className="font-mono text-xs text-[#52504A]">// VERIFIED ADMISSION &amp; PASS DESK</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
                ...
                <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3.5 bg-[#141413] hover:bg-[#C84B31] text-white font-sans font-bold text-xs uppercase tracking-wider transition mt-2"
                >
            ...
            <p className="text-center pt-4 border-t border-[#DCD7CE] font-sans text-xs text-[#52504A]">
                New to Eventora? <Link to="/register" className="text-[#C84B31] font-bold hover:underline">Create Account</Link>
            </p>
        </div>
    );
};
